...
public class DriverMapActivity extends FragmentActivity implements OnMapReadyCallback, RoutingListener{
    ...
    private String customerId = "", destination,titlee,detailss,tempKeyForDriver,customerIdForDriver;
    private LatLng destinationLatLng, pickupLatLng;
    private float rideDistance;

    Marker pickupMarkerDriverActivity;
                        ...
                        assignedTempKeyRef.addValueEventListener(new ValueEventListener() {
                            ...
                            public void onDataChange(DataSnapshot dataSnapshot) {
                                if (dataSnapshot.exists()) {
                                    ...
                                    Toast.makeText(DriverMapActivity.this,"In assigned TEMPKey Ref eventListener"+tempKeyForDriver,Toast.LENGTH_SHORT).show();
                                }
                            }
...
//                    moveCustomerRequestToDriverId(fromPath,toPath);
                                    ...
                                    Toast.makeText(DriverMapActivity.this,"No dataSnapshot exists!",Toast.LENGTH_SHORT).show();
                                }
                            }
                        ...
                        Toast.makeText(DriverMapActivity.this,"Customer Request added!",Toast.LENGTH_SHORT).show();
                    ...
                    case 3:
                        ...
                        recordRide();
                        endRideDriver();
                        Toast.makeText(DriverMapActivity.this,"Stage 3! Ended ride.",Toast.LENGTH_SHORT).show();

                        Intent i = new Intent(DriverMapActivity.this, ChooseActivity.class);
                ...
                toPath.setValue(dataSnapshot.getValue(), new DatabaseReference.CompletionListener() {
                    ...
                    public void onComplete(DatabaseError firebaseError, DatabaseReference firebase) {
                        if (firebaseError != null) {
                            ...
                            Toast.makeText(DriverMapActivity.this,"Copied!",Toast.LENGTH_SHORT).show();
                        } else {
                            //notifyCustomer();
                            Toast.makeText(DriverMapActivity.this,"Copy failed!",Toast.LENGTH_SHORT).show();
